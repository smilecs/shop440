...
import com.shop440.features.checkout.CheckoutContainerActivity
...
import com.shop440.repository.dao.models.Image
...
class ProductViewActivity : AppCompatActivity(), OnMapReadyCallback, ProductViewContract.View {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        val notifCount = view.findViewById<TextView>(R.id.notif_count)
        if(count > 0){
            notifCount.visibility = View.VISIBLE
            notifCount.text = count.toString()
            return true
        }
        view.findViewById<RelativeLayout>(R.id.parentView).visibility = View.GONE
        return true
    }
